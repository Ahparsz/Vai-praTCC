...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27-Nov-2021 às 00:40
...
INSERT INTO `favorito` (`id_cidade`, `id_usuario`) VALUES
(16, 5),
(55, 5),
(53, 2),
(67, 2),
...
--
ALTER TABLE `cidade`
  MODIFY `cd_cidade` int(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;
...
--
ALTER TABLE `favorito`
  ADD CONSTRAINT `favorito_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`cd_usuario`),
  ADD CONSTRAINT `fk_cidadefavorito` FOREIGN KEY (`id_cidade`) REFERENCES `cidade` (`cd_cidade`);
COMMIT;
