...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27-Nov-2021 às 06:01
...
INSERT INTO `regiao` (`cd_regiao`, `nm_regiao`, `info`) VALUES
(1, 'Sudeste', 'O sudeste do Brasil é uma das cinco divisões regionais do nosso país.\r\n                O sudeste é uma das menores regiões do Brasil, ocupando 11% do território. Entretanto, é a região mais povoada, com uma densidade populacional de 90 habitantes por quilômetro quadrado.\r\n                É nela que estão grandes centros como São Paulo e Rio de Janeiro, duas cidades globais, que exercem influência sobre todo o território nacional.'),
(2, 'Sul', 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'),
(3, 'Norte', 'BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB'),
(4, 'Nordeste', 'CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC'),
(5, 'Centro-Oeste', 'VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV');
...
--
ALTER TABLE `favorito`
  MODIFY `cd_favorito` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `usuario`
--
ALTER TABLE `usuario`
  MODIFY `cd_usuario` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
